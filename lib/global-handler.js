...
function init(config) {
    ...
    hap = require(path.join(config.homebridgeBasePath, 'node_modules', 'hap-nodejs'));
    ...
    once = require(path.join(config.homebridgeBasePath + 'node_modules/hap-nodejs/lib/util/once').once;
