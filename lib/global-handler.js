...
function init(config) {
    ...
    let hapBasePath;
    try {
        hapBasePath = require.resolve('hap-nodejs', {paths: [path.join(config.homebridgeBasePath, 'node_modules'), config.homebridgeBasePath, path.join(config.homebridgeBasePath, '..')]});
    }
    catch (err) {
