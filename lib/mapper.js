...
module.exports = function (config) {
    ...
    var accTypes = require(config.homebridgeBasePath + 'node_modules/hap-nodejs/accessories/types'); // change??
    var serviceTypeMap = {};
    ...
    module.mapServiceType = function (serviceUUID) {
    ...
    module.mapCharacteristicType = function (charUUID) {
