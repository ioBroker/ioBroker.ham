...
function init(config) {
    ...
    async function accessoryLogic(accessory, external) {
        async function iterateCharArray(chars, dev_idname, sr_id, sr_idname) {
        ...
        for (const index in accessory.services) {
            ...
            await iterateCharArray(service.characteristics, dev_idname, sr_id, sr_idname);
            if (service.optionalCharacteristics) {
                await iterateCharArray(service.optionalCharacteristics, dev_idname, sr_id, sr_idname);
            }
        }
    }
